...
public class AddItemDialogFragmentTest {
    ...
    public void clickButtons() throws Exception {
        ...
        ((AlertDialog) dialog.getDialog()).findViewById(R.id.btn_QI).performClick();
        ((AlertDialog) dialog.getDialog()).findViewById(R.id.btn_QII).performClick();
        ((AlertDialog) dialog.getDialog()).findViewById(R.id.btn_QIII).performClick();
        ((AlertDialog) dialog.getDialog()).findViewById(R.id.btn_QIV).performClick();
    }
